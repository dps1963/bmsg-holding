...
Forms uses `/api/v1/forms`; contact-v1.js and CSS are vendored version 1.0.0. No runtime shared source. This website never reads a product or platform database. Its outage does not restart Forms, CRM, Email or another website. HTML cache is five minutes; contact configuration is never cached. Source changes do not alter DNS automatically. Current staging URL: https://bmsg-public.stg.bringmesunshinegroup.com/ . Production cutover remains blocked by the migration acceptance gates.
